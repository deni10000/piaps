...
public class Main {
    ...
    ResearchAssociate employee1 = new ResearchAssociate(1, "Sara Connor", "saratheterminator@gmail.com", "economy");
    ResearchAssociate employee2 = new ResearchAssociate(2, "Evgeniya Sergeeva", "evg_segio@gmail.com", "economy");
    ResearchAssociate employee3 = new ResearchAssociate(3, "Oleg Matveev", "matveev2oleg44@gmail.com", "finance");
    ResearchAssociate employee4 = new ResearchAssociate(4, "John Cena", "wwechampion@gmail.com", "finance");
    ...
    Lecturer lecturer1 = new Lecturer(5, "Dmitry Vlasov", "vlasovdmitry12@gmail.com", "finance");
    lecturer1.setCourses(new Course[]{course1});

    AdministrativeEmployee administrativeEmployee = new AdministrativeEmployee(6,
            "Anton Pekshev", "moonpekshev@gmail.com", "admin");
